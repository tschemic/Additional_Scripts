# Beispiel um Daten in DB in Shiny App zu editieren
...
#edit data - Achtung: bei Auswahl mehrerer Reihen und dann Deselektion, wird 
# zuletzt ausgewählte editiert nicht aktuell ausgewählte!!!
